...
CREATE POLICY "Allow authenticated users to All" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to All" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to All" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
